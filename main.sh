...
MINIO_SKIPPED_TAGS="((minio|mc):latest)|(k8s-operator|minio|mc|mint):(.*(mint|cicd|arch64|RELEA|arm).*|(v.*-)*[0-9]{6}*-([a-z]|[A-Z]|[0-9]){6,8}|dev-|v[0-9]+.[0-9]+.[0-9]+-[0-9]+-.*|[0-9]{5,6}-[a-z0-9]{7})"
SKIPPED_TAGS="$MINIO_SKIPPED_TAGS"
...
minio/mc
"
ONLY_ONE_MINOR="postgres|nginx|opensearch|elasticsearch|k8s-operator|minio|mc|mint"
...
minio/minio/dev\
 minio/minio/edge\
 minio/minio/latest\
 minio/minio/master::30
minio/mint/edge\
 minio/mint/latest::30
minio/k8s-operator/edge\
 minio/k8s-operator/latest::30
minio/k8s-operator/1.0.9\
 minio/k8s-operator/2.0.9\
 minio/k8s-operator/v0.3.23\
 minio/k8s-operator/v3.0.29::30
"
